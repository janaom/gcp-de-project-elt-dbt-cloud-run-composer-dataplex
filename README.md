...
Start by preparing your dbt files, Dockerfile, `cloudbuild.yaml`, and other necessary files. The complete code is available on my GitHub.
...
If it's a new service for you, I would recommend creating the Function manually. Go to Cloud Run -> Services -> Write a function. You can find the code here: cloud-run-function.
